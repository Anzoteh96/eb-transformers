...
with open('/Users/nicolascannella/Repos/eb-transformers/mse_outeb_2025_09_18-21_43_wrq.pkl_0_2__0.0', 'rb') as f:
    data = pickle.load(f)
...
regret_df = mse_to_regret(mses_df, args_col='Model', bayes_key='transformer')
print(regret_df)
...
data = torch.load('/Users/nicolascannella/Repos/eb-transformers/mse_outeb_2025_09_18-21_43_wrq.pkl_0_2__0.0', map_location=torch.device('cpu'), weights_only=False)
